...
import { ChevronRight, KeyboardArrowDown, RelumeIcon } from "relume-icons";
                        ...
                        <div className="grid auto-cols-fr grid-cols-1 grid-rows-[max-content_max-content_max-content_max-content] gap-y-2 md:gap-y-4">
                          ...
                          >
                            ...
                            <div className="flex flex-col items-start justify-center">
                              <h5 className="font-semibold">Getting Started</h5>
                              <p className="text-small hidden md:block">
                                Learn how to create listings quickly.
                              </p>
                            </div>
                          </a>
                          <a
                          ...
                          >
                            ...
                            <div className="flex flex-col items-start justify-center">
                              ...
                              <p className="text-small hidden md:block">
                                Get assistance with your account anytime.
                              </p>
                            </div>
                          </a>
                          <a
                          ...
                          >
                            ...
                            <div className="flex flex-col items-start justify-center">
                              ...
                              <p className="text-small hidden md:block">
                                Read the latest marketing tips and trends.
                              </p>
                            </div>
                          </a>
                          <a
                        ...
                        <div className="grid auto-cols-fr grid-cols-1 grid-rows-[max-content_max-content_max-content_max-content] gap-y-2 md:gap-y-4">
                          ...
                          >
                            ...
                            <div className="flex flex-col items-start justify-center">
                              ...
                              <p className="text-small hidden md:block">
                                See how others succeeded with our platform.
                              </p>
                            </div>
                          </a>
                          <a
                            ...
                            <a href="#" className="flex flex-col py-2">
                              ...
                              <div className="mt-2 flex max-w-[18rem] flex-col justify-start md:mt-0">
                                ...
                                <p className="text-small">
                                  Discover strategies for effective real estate
                                  marketing.
                                </p>
                                <div className="mt-2">
                                  <Button
